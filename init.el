  ...
  (setq-default
   ...
   '(
     ...
     (org :variables
          ...
          org-agenda-files (list "~/org/" "~/org/log/" "~/org/notes/")
     ...
     ;; cc-mode
     docker
     q-mode ;; private layer in ~/.emacs.d/private
     conda  ;; private layer in ~/.emacs.d/private
     )
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-smart-closing-parenthesis nil    ; =t= was freezing org-mode
